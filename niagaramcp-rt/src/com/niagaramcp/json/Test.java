...
/**
 * Тестовый класс для проверки основных возможностей JSON-библиотеки.
 */
public class Test {
   public static void main(String[] args) {
      ...
      try {
         ...
         System.out.println("");
         JSONObject j = XML.toJSONObject("<![CDATA[This is a collection of test patterns and examples for org.json.]]>  Ignore the stuff past the end.  ");
         ...
         s = jj.object().key("single").value("MARIE HAA'S").key("Johnny").value("MARIE HAA\\'S").key("foo").value("bar").key("baz").array().object().key("quux").value("Thanks, Josh!").endObject().endArray().key("obj keys").value(JSONObject.getNames((Object)obj)).endObject().toString();
         ...
         jj.key("big").value(1.23456789E96);
         jj.key("small").value(1.23456789E-80);
         ...
         j.put("Testing JSONString interface", (Object)obj);
         System.out.println(j.toString(4));
         ...
         j.put("String", (Object)"98.6");
         j.put("JSONObject", (Object)(new JSONObject()));
         j.put("JSONArray", (Object)(new JSONArray()));
         j.put("int", 57);
         j.put("double", 1.2345678901234568E29);
         j.put("true", true);
         j.put("false", false);
         j.put("null", JSONObject.NULL);
         j.put("bool", (Object)"true");
         j.put("zero", -0.0);
         j.put("\\u2028", (Object)"\u2028");
         j.put("\\u2029", (Object)"\u2029");
         ...
         a.put(666);
         a.put(2001.99);
         a.put((Object)"so \"fine\".");
         a.put((Object)"so <fine>.");
         a.put(true);
         a.put(false);
         a.put((Object)(new JSONArray()));
         a.put((Object)(new JSONObject()));
         j.put("keys", (Object)JSONObject.getNames(j));
         System.out.println(j.toString(4));
         System.out.println(XML.toString(j));
         ...
         System.out.println("string " + j.getDouble("string"));
         j.put("good sized", Long.MAX_VALUE);
         System.out.println(j.toString(4));
         ...
         Collection c = null;
         Map m = null;
         j = new JSONObject((Map)m);
         a = new JSONArray((Collection)c);
         ...
         j.put("map", (Map)m);
         j.put("collection", (Collection)c);
         j.put("array", (Object)a);
         a.put((Map)m);
         a.put((Collection)c);
         System.out.println(j.toString(4));
         ...
         try {
            System.out.println(j.put((String)null, (Object)"howard"));
         } catch (Exception e) {
            System.out.println(e);
         }
