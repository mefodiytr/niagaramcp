...
/**
 * Утилита для конвертации HTTP-cookie между строковым представлением и {@link JSONObject}.
 */
public class Cookie {
