...
public class JSONObject {
   ...
   static BigDecimal objectToBigDecimal(Object val, BigDecimal defaultValue) {
      if (NULL.equals(val)) {
         ...
         return !numberIsFinite((Number)val) ? defaultValue : new BigDecimal(((Number)val).doubleValue());
      }
   }
   ...
   public static String quote(String string) {
      ...
      synchronized(sw.getBuffer()) {
         String quoted;
         try {
            quoted = quote(string, sw).toString();
         } catch (IOException ignored) {
            return "";
         }
   ...
   public boolean similar(Object other) {
      try {
         if (!(other instanceof JSONObject)) {
            ...
            while(iter.hasNext()) {
               Map.Entry<String, ?> entry = (Map.Entry)iter.next();
   ...
   static boolean isNumberSimilar(Number l, Number r) {
      if (numberIsFinite(l) && numberIsFinite(r)) {
         if (l.getClass().equals(r.getClass()) && l instanceof Comparable) {
            ...
            BigDecimal lBigDecimal = objectToBigDecimal(l, (BigDecimal)null);
            BigDecimal rBigDecimal = objectToBigDecimal(r, (BigDecimal)null);
   ...
   public Writer write(Writer writer, int indentFactor, int indent) throws JSONException {
      try {
         ...
         if (length == 1) {
            ...
            for(Iterator iter = this.entrySet().iterator(); iter.hasNext(); needsComma = true) {
               Map.Entry<String, ?> entry = (Map.Entry)iter.next();
               if (needsComma) {
                  writer.write(44);
               }
   ...
   public Map<String, Object> toMap() {
      ...
      Map.Entry entry;
      Object value;
      for(Iterator iter = this.entrySet().iterator(); iter.hasNext(); results.put((String) entry.getKey(), value)) {
